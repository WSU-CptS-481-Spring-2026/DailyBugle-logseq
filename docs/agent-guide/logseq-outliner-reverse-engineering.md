...
Companion UML artifact: `logseq-outliner-reverse-engineering-uml.puml` in the same `docs/agent-guide` directory. If your markdown viewer does not render Mermaid diagrams, use the `.puml` file as the visible UML source.
